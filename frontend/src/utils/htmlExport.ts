    ...
    for (var i = 0; i < ids.length; i++) {
      ...
      try {
        ...
        wrapper.innerHTML = '<div class="mermaid-topbar" style="display:flex;align-items:center;justify-content:space-between;padding:8px 12px;background:#f8fafc;border-bottom:1px solid #e2e8f0;font-size:12px;">'
          ...
          + '</div>'
          + '<button class="mm-btn fit-margin-btn active" style="height:28px;width:28px;padding:0;border-radius:8px;border:1px solid #e2e8f0;background:#fff;cursor:pointer;display:inline-flex;align-items:center;justify-content:center;color:#475569;box-shadow:0 1px 2px rgba(0,0,0,0.04);" title="Margin Fitted: Detect & reduce vertical margin space for current zoom"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="7 15 12 20 17 15"/><polyline points="7 9 12 4 17 9"/></svg></button>'
